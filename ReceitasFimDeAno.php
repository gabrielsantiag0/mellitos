...
<body>
    ...
    <main class="container mt-5 border border-1 border-black">
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4 m-4">
            <div class="col">
              <div class="card">
                <img src="Img/PavêDeSorveteComBrownie.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card">
                <img src="Img/ChristmasCake.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card">
                <img src="Img/BavaroiseDeLimão.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card">
                <img src="img/AbacaxiáPolinésia.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                  <img src="img/CupcakeDeMorango.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card">
                  <img src="img/PeruRecheadoComFarofaDeFrutas.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
