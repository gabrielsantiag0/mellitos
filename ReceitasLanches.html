...
<body>
    ...
    <main class="container mt-5 border border-1 border-black">
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4 m-4">
            <div class="col">
              <div class="card">
                <img src="Img/SaladaDeFrutasAoFornoComCremeDePêssego.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card">
                <img src="Img/SaladaDeCevadinha.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card">
                <img src="Img/SopaDeCebolaEspecial.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card">
                <img src="img/BoloSalgadoDeAtum.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                  <img src="img/QuicheDePresunto.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card">
                  <img src="img/RefrescoDeMelancia.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card">
                  <img src="img/TortaFolhadaDeLegumes.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
